...
public class FlowerArea : MonoBehaviour
{
    ...
    // The list of all flower plants in this flower area (flower plants have multiple flower)
    ...
    /// <summary>
    /// Reset flowers and flowers plants
    /// </summary>
    ...
    private void Start()
    {
        //Find all flowers taht are children of this GameObject/Transform
        FindChildFlowers(transform);
    }
    /// <summary>
    /// This function finds all flowers and flower plants that are children of a parent transform
    /// </summary>
